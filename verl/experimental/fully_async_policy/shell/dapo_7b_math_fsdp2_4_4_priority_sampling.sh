...
exp_name='GRPO-Qwen2.5-3b-instruct-MATH-fully-async-4-4-priority-sampling'

# ==================== Paths ====================
RAY_DATA_HOME=${RAY_DATA_HOME:-"${HOME}/verl"}
MODEL_PATH=${MODEL_PATH:-"/apdcephfs/share_302503006/ziniuli/models/Qwen/Qwen2.5-3B-Instruct"}
CKPTS_DIR=${CKPTS_DIR:-"/apdcephfs/share_302503006/ziniuli/project/verl-main/exp_hub"}
TRAIN_FILE=${TRAIN_FILE:-"/apdcephfs/share_302503006/ziniuli/processed_dataset/lighteval-MATH/train_evaluated_n16.parquet"}
TEST_FILE=${TEST_FILE:-"/apdcephfs/share_302503006/ziniuli/processed_dataset/lighteval-MATH/test_500.parquet"}
...
priority_strategy="medium_sharp"
...
python -m verl.experimental.fully_async_policy.fully_async_main \
    ...
    rollout.nnodes="${NNODES}"    rollout.n_gpus_per_node="${n_gpus_rollout}" \
