...
# Equivalent to ppo_mini_batch_size (prompts) * rollout.n * max_training_steps.
total_rollout_steps=$(((512*n_resp_per_prompt*400)))
test_freq=20
staleness_threshold=0.1
trigger_parameter_sync_step=4require_batches=4
