...
# Equivalent to train_batch_size (prompts) * n_resp_per_prompt * max_training_steps.
train_prompt_budget=$(((512*400)))
total_rollout_steps=$((train_prompt_budget * n_resp_per_prompt))
test_freq=20
...
python -m verl.experimental.fully_async_policy.fully_async_main \
    ...
    actor_rollout_ref.actor.optim.lr_decay_steps=${train_prompt_budget} \
