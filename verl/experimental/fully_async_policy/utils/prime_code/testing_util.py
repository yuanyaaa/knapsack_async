...
def _runtime_module_from_string(name, source):
    """Replacement for pyext.RuntimeModule.from_string(name, "", source).
    pyext is not compatible with Python 3.12+ due to invalid escape sequences.
    """
